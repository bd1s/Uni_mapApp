...
const locations = [
{ name: "Administration", coordinates: { latitude: 33.226510, longitude: -8.486939 } },
  { name: "Bibliothèque", coordinates: { latitude: 33.226328, longitude: -8.487133 } },
  ...
  { name: "Amphé 1 Al Farabi", coordinates: { latitude: 33.226165, longitude: -8.48664 } },
  { name: "Amphé 2 Al Bayrouni", coordinates: { latitude: 33.225850, longitude: -8.4871 } },
  { name: "Amphé 3 Ibno Haitam", coordinates: { latitude: 33.225521, longitude: -8.487151 } },
  ...
  { name: "Bloc A", coordinates: { latitude: 33.225390, longitude: -8.485967 } },
  { name: "Bloc C", coordinates: { latitude: 33.226161, longitude: -8.488013 } },
  { name: "Bloc D", coordinates: { latitude: 33.225830, longitude: -8.488338 } },
  { name: "Toilette", coordinates: { latitude: 33.22517, longitude: -8.48556 } },
  ...
  { name: "Toilette", coordinates: { latitude: 33.22478, longitude: -8.48725 } },
...
const GOOGLE_MAPS_APIKEY = "AIzaSyCSyvolGooAFTh7AGtHUXF92MWHoPTrt_4";
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.mapTypeButton} onPress={toggleMapType}>
        <Text style={styles.mapTypeButtonText}>
          {mapType === "standard" ? "Passer à Satellite" : "Passer à Par défaut"}
        </Text>
      </TouchableOpacity>
    </View>
  );
